...
### 1. Topic Converter
Univerzální nástroj pro převod dokumentů mezi různými formáty.
- **Podporované formáty**: `DOCX`, `Markdown`, `HTML`.
- **Dva pracovní módy**:
...
1. **Naklonuj repozitář**:
   ```bash
   git clone https://github.com/MonsterMarian/MyTools.git
   ```

2. **Nainstaluj závislosti pro Converter**:
   ```bash
   cd Converter
   npm install
   ```

3. **Spusť svůj oblíbený mód**:
